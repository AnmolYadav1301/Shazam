...
Shazam is a project aimed at creating a music recognition system similar to Shazam, implemented using C++.
...
1. **Clone the repository**:
    ```sh
    git clone https://github.com/AnmolYadav1301/Shazam.git
    cd Shazam
    ```
